...
public final class SyntacticEquivalence {
  ...
  /**
   * @return true, if nodes are syntactically equivalent
   * Use equivalenceFilter to redefine the equivalence of two nodes
   */
   ...
   * Use equivalenceFilter to redefine the equivalence of two nodes
   */
  private static boolean areEquivalent(@Nullable Tree leftNode, @Nullable Tree rightNode, BiPredicate<JavaTree, JavaTree> equivalenceFilter) {
